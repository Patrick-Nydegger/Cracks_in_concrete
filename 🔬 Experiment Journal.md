...
*   **Training Curves:**
    *(Please insert the plots generated by the code here. They will show rapid convergence for MobileNetV2 and slightly slower, but steady improvement for OPNet.)*
